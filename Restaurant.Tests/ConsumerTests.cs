...
namespace Restaurant.Tests
{
    ...
    public class ConsumerTests
    {
        ...
        public async Task Any_booking_request_consumed()
        {
            ...
            await _harness.Bus.Publish((IBookingRequest) new BookingRequest(orderId, Guid.NewGuid(), null, DateTime.Now.ToString()));
        ...
        public async Task Booking_request_consumer_published_table_booked_message()
        {
            ...
            await bus.Publish((IBookingRequest)new BookingRequest(orderId, orderId, null, DateTime.Now.ToString()));
        ...
        [Test]
        public async Task Booking_request_consumer_published_table_booked_message2()
        {
